		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				<li>
					...
					<i class="icon-angle-right"></i>
					<a href="Datewise_final.php">Datewise History</a>
					<i class="icon-angle-right"></i>
					<a href="#">Total orders between given date</a>
					<i class="icon-angle-right"></i>
					<a href="#">Details of selected order</a>
			...
			<a href="#" class="btn btn-primary">Save changes</a>
				...
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><b><font size="3">Details of order</font></h2>
...
<?php
	...
	$sql1= "SELECT item_id,qty,item_price from placeorder WHERE order_id='$o_id'";
	...
	$i=0;
	          while($row1 = mysqli_fetch_assoc($res1))
	          {
		          ...
		          $sql2= "SELECT * from products where item_id='$item'";
		...
		$i++;
          ...
          ?>
	              ...
	              <tr>
	              	...
	              	<td class="center"><?php echo $cat ?></td>
	              	<td class="center"><?php echo $item1 ?></td>
	              	...
	              	<td class="center"><?php echo $orderdate ?></td>
...
<form method="Post" action="Datewise_php.php">
<input type="hidden" name="from_date" value="<?php echo $start; ?>">
<input type="hidden" name="till_date" value="<?php echo $end; ?>">
&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
<input id="saveForm" class="btn btn-primary13" align="right" type="submit" name="accept" value="Back" />
