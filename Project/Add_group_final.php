...
<?php
    ...
    require_once('Add_group_php.php');
    $j= new add_group1();
   $ch=$j->add_group();
?>
...
<body>
	...
	<br>
		...
		<form id="form_992796" class="appnitro"  method="POST" action="Add_group_final.php">
					<div class="form_description">
			<h2><b>Add New Group</h2>
			<p></p>
	<img id="top" src="top.png" alt="">
	
		</div>						
			<ul style=" height: 650px; font-size: 14px; overflow: auto;">
			
	<li id="li_1" >
		<label class="description" for="group_name">Group Name</label>
			<input id="element_1" name="group_name" class="element text large" type="text" placeholder="Group Name" size="100"/> 
		</li>	<br>
						
							<li class="buttons">
			    
				<input id="saveForm" class="btn btn-primary" type="submit" name="submit" value="Create Group"/> 
				<?php 
