...
<body>
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				<li>
					...
					<i class="icon-angle-right"></i>
					<li><a href="#">View Stock Details</a></li>
				</li><br><br>
	...
	<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><b><font size="3">View Stock Details</font></h2>
	...
	<img id="bottom" src="bottom.png" alt="">
				...
				$sql = "SELECT DISTINCT model,price,category,color,size,stock_commmited,stock_available FROM products ORDER BY category, model, color, size";
				$result = mysqli_query($con,$sql);
				$i=0;
				if($result)
				{
					...
					while($row = mysqli_fetch_assoc($result))
					{
						...
						$colour=$row['color'];
						$size=$row['size'];
						$stock_com=$row['stock_commmited'];
						$stock_ava=$row['stock_available'];
					$i++;	
?>
                    <tbody>
		               <tr>
		               ...
		               <td class="center"><?php echo $model; ?></td>
		               <td class="center"><?php echo $colour; ?></td>       
		               <td class="center"><?php echo $size; ?></td>       
		               <td class="center"><?php echo $stock_com; ?></td>  
		               <td class="center"><?php echo $stock_ava; ?></td>
