...
<body>
			...
			<a href="#" class="btn btn-primary">Save changes</a>
				...
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><b><font size="3">Total orders between given date</font></h2>
	...
	mysqli_select_db($con,"order_manager")or die(mysqli_connect_error($con));
     ...
     $sql ="SELECT orders.order_id,orders.Retailerid,orders.order_date,orders.bill_amt,retailers.r_name,retailers.rating FROM orders,retailers WHERE orders.order_date>='$start' and orders.order_date<='$end'";
	  ...
	  <tbody>
		...
		<li class="buttons">
		    ...
		    <ul class="no_bullets" id="button34">
				...
				<a href="view_details_status1.php?value=<?php echo $o_id; ?>&from=<?php echo $start; ?>&till=<?php echo $end; ?>">    
