...
<body>
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				<li>
					...
					<i class="icon-angle-right"></i>
					<li><a href="#">Retailer-wise History</a></li>
				</li><br>
				<br>
	...
	<br>
		...
		<form id="form_992796" class="appnitro"  method="post" action="retailerwise_php.php">
					<div class="form_description">
			<h2><b>Retailer-wise Order History</h2>
			<p></p>
	<img id="top" src="top.png" alt="">
		...
		<div>
			<input id="element_1" name="r_name" class="element text large" type="text" placeholder="Retailer's Name" size="100"/> 
		</div> <br>
		</li>	
