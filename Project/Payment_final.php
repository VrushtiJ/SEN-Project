...
<br>
	...
	<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><b><font size="3">Payment Status</font></h2>
...
$sql ="SELECT orders.Retailerid,orders.order_id,orders.order_date,orders.bill_amt,orders.dispatch_date FROM orders where dispatch_status=1 and payment_status=0 ";
//$count = 1;
$result = mysqli_query($con,$sql);
				...
				$i=0;
					...
					$i++;
						...
						$sql1="SELECT r_name,contact_no FROM retailers where Retailerid='$r_id' " ;
						$result1 = mysqli_query($con,$sql1);
						$row1=mysqli_fetch_assoc($result1);
		...
		<tr>	
			...
			<td>
			<li class="buttons">
				<a href="payment_status.php?value=<?php echo $o_id; ?>">   
				<li value="<?php echo $o_id; ?>">  
				<input id="saveForm" class="btn btn-primary18" type="submit" name="dispatch" value="Paid" /> </a></li>
			</td>	  
				  <?php
					if(isset($_POST['Paid']))
					{
