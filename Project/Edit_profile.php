...
?>
<?php
 require_once("Edit_profile_php.php");
 $j=new profile();
 $ch=$j->Edit_profile();
?>
<!DOCTYPE html>
			...
			<div class="container-fluid">
				...
				<?php
                    ...
                    <?php	
						...
						<li class="dropdown">
							<a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
								<i class="halflings-icon white"></i><?php echo $op_user ?>
								<span class="caret"></span>
							</a>
							<ul class="dropdown-menu">
								<li><a href="View_profile_operator.php"><i class="halflings-icon user"></i> Profile</a></li>
								<li><a href="Change_password.php"><i class="halflings-icon off"></i>Change password</a></li>
		...
		<div class="row-fluid">
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							...
							<ul>
								...
								<li><a class="submenu" href="Orders_dispatched.php"><i class="icon-align-justify"></i><span class="hidden-tablet">Orders to be dispached</span></a></li>
						...
						<li><a href="Place New Order.php"><i class="icon-edit"></i><span class="hidden-tablet"> Place New Orders</span></a></li>
					...
					<!--	<li><a href="widgets.php"><i class="icon-dashboard"></i><span class="hidden-tablet">Payment</span></a></li>-->
					<li>
			...
			<ul class="breadcrumb">
				<li>
					...
					<a href="View_profile_operator.php">View profile of the operator</a>
					
					<i class="icon-angle-right"></i>
					<a href="#">Update Profile of Operator</a>
				</li><br> <br>
			...
			<a href="#" class="btn btn-primary">Save changes</a>
				...
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><b><font size="3">Update Profile of Operator</font></h2>
...
<?php
	...
	mysqli_select_db($con,"order_manager")  or die(mysqli_connect_error($con));
     //$o_id=$_GET['value'];
	$sql = "SELECT * from operator where username='$op_user'";
	...
	if($res){
	     while($row = mysqli_fetch_assoc($res)){
		     ...
		     $email = $row['email_id'];
		     ?>
               <form name="myform" action="Edit_profile.php" method="Post" onsubmit="return validate();  ">
			
					<li>
		<label class="description" ><font color="#211D5C">Name:&nbsp;&nbsp;</font> </label>
		<div>
			<input class="element text medium" style="font-weight: bold;" name="name" type="text" value="<?php  echo $name; ?>" size="70" /> 
		...
		<div>
			<input class="element text small" style="font-weight: bold;"  size="4" type="text" value="<?php  echo $user; ?>" readonly/> 
			</div>
			<br>
		</li>
	     <li>
		...
		<div>
			<input class="element text small" style="font-weight: bold;" type="date" size="4" name="dob" value="<?php  echo $dob; ?>" /> 
		</div> 
		 <br>
		</li>

		<li>
		<label class="description" ><font color="#211D5C">Address:&nbsp;&nbsp;</font> </label>
		<div>
			<input class="element text medium" style="font-weight: bold;" name="address" type="text" value="<?php  echo $address; ?>" size="70" /> 
		...
		<div>
			<input class="element text small" style="font-weight: bold;" type="number" size="4" name="cont_no" value="<?php  echo $number; ?>" /> 
		</div>
		 <br>
		</li>
		...
		<div>
			<input class="element text medium" style="font-weight: bold;" size="4" name="email" type="text" value="<?php  echo $email; ?>" /> 
		</div> <br>
		</li>
			<?php 
