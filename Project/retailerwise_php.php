...
<body>
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				<li>
					...
					<i class="icon-angle-right"></i>
					<li><a href="Retailerwise_final.php">Retailer-wise History</a></li>
					<i class="icon-angle-right"></i>
			...
			<a href="#" class="btn btn-primary">Save changes</a>
				...
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><b><font size="3">Retailer Details</font></h2>
	...
	$name = $_POST['r_name'];
	$sql = "SELECT * from retailers where r_name like '%$name%'";
	$result = mysqli_query($con,$sql);
	...
	$i=0;
     ...
     ?>
	  <tbody>
		...
		<td class="center"><?php echo $shop; ?></td>
		<td>
		<li class="buttons">
	...
	<?php	}
     ...
     <form action="Retailerwise_final.php">
				<input id="saveForm" class="btn btn-primary" align="right" type="submit" name="accept" value="Back" />
	<br><br>
	</form>
	<img id="bottom" src="bottom.png" alt="">
