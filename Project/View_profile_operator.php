		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				<li>
					...
					<a href="#">View profile of the operator</a>
				</li><br> <br>
...
<?php
	...
	if($res){
		...
		<li>
		<label class="description"><font color="#211D5C">&nbsp;&nbsp;Operator ID:&nbsp;&nbsp;</font> </label>
		<div>
		&nbsp;&nbsp;	<input class="element text small" style="font-weight: bold;" size="4" value="<?php  echo $id; ?>" /> 
		</div> <br>
		</li>
