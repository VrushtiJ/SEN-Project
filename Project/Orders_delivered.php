		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				<li>
					...
					<a href="#">Orders</a>
					<i class="icon-angle-right"></i>
					<a href="Orders_dispached.php">Orders delivered</a>
				</li><br> <br>
...
$sql ="SELECT orders.Retailerid,orders.order_id,orders.order_date,orders.bill_amt,retailers.r_name,retailers.rating FROM orders,retailers WHERE orders.dispatch_status = 1 and orders.delivery_status=0 AND retailers.Retailerid=orders.Retailerid";
$result = mysqli_query($con,$sql);
		...
		<li class="buttons">
		    ...
		    <ul class="no_bullets" id="button34">
				...
				<a href="delivery_status.php?value=<?php echo $o_id; ?>">   
				<li value="<?php echo $o_id; ?>">  
				     <center><input id="saveForm" class="btn btn-primary11" type="submit" name="deliver" value="Delivered" /> </a>
				     </center>
				  <?php 
...
<?php	//					echo ("<tr><td>$name</td><td>$r_id</td><td>$o_id</td><td>$amt</td><td>$rating</td><td>$date</td>");
?>			<?php		}
				}
 ?>				
