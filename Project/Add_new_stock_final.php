...
date_default_timezone_set('Asia/Calcutta');
    ...
    require_once('Add_new_stock_php.php');
    $j= new add_stock();
   $ch=$j->add_stocks();
?>
<!DOCTYPE html>
...
<body>
	...
	<br>
		...
		<form id="form_992796" class="appnitro"  method="post" action="" onsubmit="return validate()">
			...
			<h2><b >Add Stock to Existing products</h2>
			<p></p>
...
<!--			<input id="element_2" name="element_2" class="element text medium" type="text" value=""/> -->
	...
	<option value="Select"> Select </option>
		...
		<div>
			<input id="element_5" name="element_5" class="element text small" type="number" placeholder="Quantity" required/> 
		</div> <br>
		</li>		<li id="li_6" >
		<label class="description" for="element_6">Confirm Quantity </label>
		<div>
			<input id="element_6" name="element_6" class="element text small" type="number" placeholder="Confirm Quantity" required/>
		</div> <br>
		</li>
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input id="saveForm" class="btn btn-primary" type="submit" name="submit" value="Add Other Stock" />
		</li>
		<?php 
