			...
			<a href="#" class="btn btn-primary">Save changes</a>
				...
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><b><font size="3">View profile of the operator</font></h2>
...
<?php
	...
	$o_id = $_GET['value'];
	$sql = "SELECT * from operator where oeprator_id='$o_id'";
	...
	if($res){
		...
		<div>
			<input class="element text small" style="font-weight: bold;" size="4" value="<?php  echo $add; ?>" readonly/> 
		</div> <br>
		</li>
