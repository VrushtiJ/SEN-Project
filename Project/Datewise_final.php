		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				<li>
					...
					<i class="icon-angle-right"></i>
					<li><a href="#">Date-wise History</a></li>
				</li><br>
<br>
	...
	<br>
		...
		<form id="form_992796" class="appnitro"  method="post" action="Datewise_php.php">
					<div class="form_description">
			<h2><b>Date-wise Order History</h2>
			<p></p>
	<img id="top" src="top.png" alt="">
		...
		<li id="li_1" >
		     ...
		     <div>
			     <input id="from_date" name="from_date" class="element text medium" type="date" placeholder="From date" size="100"/> 
			  
		     </div> <br>
		     </li>		<li id="li_2" >
		     <label class="description" for="element_2">To</label>
		     <div>
			     <input id="till_date" name="till_date" class="element text medium" type="date" placeholder="Till date"/> 
		     </div> <br>
