			...
			<a href="#" class="btn btn-primary">Save changes</a>
				...
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><b><font size="3">View profile of the operators for approval</font></h2>
...
$sql ="SELECT * FROM operator where approvedstatus='0'";
$result = mysqli_query($con,$sql);
		...
		?>
						  <tbody>
							<tr> 
								...
								<td>
								<a href="approve_op.php?value=<?php echo $o_id; ?>">   
