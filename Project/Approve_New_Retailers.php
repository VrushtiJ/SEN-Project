		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				<li>
					...
					<a href="Orders_dispached.php">Approve New Retailers</a>
				</li><br> <br>
			...
			<a href="#" class="btn btn-primary">Save changes</a>
				...
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><b><font size="3">View profile of the retailers for approval</font></h2>
...
echo $o_id;
$sql ="SELECT retailers.Retailerid,retailers.r_name,retailers.shop_name FROM retailers WHERE retailers.approved_status=0";// AND retailers.approved_by='$o_id'";
$result = mysqli_query($con,$sql);
		...
		?>
						  <tbody>
							<tr> 
								...
								<td>
								<a href="approve.php?value=<?php echo $r_id; ?>">   
								<li value="<?php echo $r_id; ?>">  
	
				     			<input id="saveForm" class="btn btn-primary14" type="submit" name="dispatch" value="View Profile" /> </a>
				     			</td>
				     		</tr>
				     	</tbody>
