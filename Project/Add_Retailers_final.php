...
?>
<?php
    require_once('retailer_group_assign_php.php');
    $j= new Change_Group1();
   $ch=$j->Change_Group();
?>
<!DOCTYPE html>
...
<body>
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				<li>
					...
					<i class="icon-angle-right"></i>
					<li><a href="#">Add Retailers to the group</a></li>
				</li><br><br>
				
	
	<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><b><font size="3">Add Retailers to the group</font></h2>
    ...
    $sql =" SELECT retailers.Retailerid,retailers.r_name,retailers.area,retailers.city FROM order_manager.retailers where retailers.group_id=1 ";
	...
	$i=0;
     ...
     ?>  <tbody>
		...
		<td class="center"><?php echo $cty; ?></td>
		<td class="center"><?php echo $are; ?></td>
		<td>
		
		<form id="form_992796" class="appnitro"  method="post" action="Add_Retailers_final.php">
		<li class="buttons">
		     ...
		     $response = array();
               $r = mysqli_query($con, "SELECT * FROM groups where group_id!=0 AND group_id!=1") or die(mysql_error());
		     ...
		     ?>
			    ...
			    <!--	<li><input id="abc" name="groupid" class="element text medium" type="text" placeholder="Group ID"></li>
			    -->	<br>
	        ...
	        <input type="hidden" name="bansari" value="<?php echo$r_id; ?>">
	        <?php 
	...
	<img id="bottom" src="bottom.png" alt="">
					...
					<!--<li id="li_1" >
						<label class="description" for="element_1">Retailer's Name</label>
						<div>
							<input id="element_1" name="element_1" class="element text large" type="text" placeholder="Retailer's Name" size="100"/> 
						</div>
					</li>	
					<li class="buttons">
