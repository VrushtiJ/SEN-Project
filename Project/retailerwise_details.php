...
<body>
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				<li>
					...
					<i class="icon-angle-right"></i>
					<a href="Retailerwise_final.php">Retailer-wise History</a>
					<i class="icon-angle-right"></i>
					<a href="#">Retailer details</a>
						<i class="icon-angle-right"></i>
					<a href="#">Retailer's order details</a>
				</li><br> <br>
			...
			<a href="#" class="btn btn-primary">Save changes</a>
				...
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><b><font size="3">Retailer's order details</font></h2>
	...
	$user = $_GET['value'];
    $sql = "SELECT Retailerid from retailers where username='$user'";                 
     $result = mysqli_query($con,$sql);
	$row = mysqli_fetch_assoc($result);
	$r_id=$row['Retailerid'];
	$sql1 = "SELECT * from orders where Retailerid='$r_id'";                 
     $result1 = mysqli_query($con,$sql1);
	...
	$i=0;
	     while($row1 = mysqli_fetch_assoc($result1))
	     {
			...
			$dis_date=$row1['dispatch_date'];
			$p_status=$row1['payment_status'];
			$amt = $row1['bill_amt'];
			if($p_status == 0){
				$value = "Unpaid";
			}else {
     ...
     ?>
	  <tbody>
		...
		<td class="center"><?php echo $o_date; ?></td>	
		<td class="center"><?php echo $dis_date; ?></td>
		...
		<li class="buttons">
		    ...
		    <ul class="no_bullets" id="button34">
				...
				<a href="order_history_details.php?value=<?php echo $o_id; ?>&user=<?php echo $user; ?>">   
				<li value="<?php echo $o_id; ?>">  
				     <input id="saveForm" class="btn btn-primary" align="middle" type="submit" name="accept" value="View Details" /></a>
			</ul>
	     </li>
		</td>
		</tr>
