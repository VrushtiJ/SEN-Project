...
<?php
    ...
    require_once('Edit_Price_php.php');
    $j= new edit_price();
   $ch=$j->edit_prices();
?>
...
function call(var c){
 	 document.getElementById('model1').value()=c;
				alert(document.getElementById('model1').value());
	...
	function validate()
	{
	 ...
	 var confirm_price=document.getElementById('element_6').value;   
	          ...
	          alert("Price and confirm price field do not match..!!");
	          return false;
	          }
	...
	<!-- end: Favicon -->
		...
		<script language="javascript">
	     function value()
	     {
	          ...
	          document.getElementById("get_category").value=val;
	     }
		</script>	
</head>
...
<body>
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				<li>
					...
					<i class="icon-angle-right"></i>
					<a href="Edit_Price_final.php">Update Price of Products</a>
	...
	<br>
		...
		<form id="form_992796" class="appnitro"  method="post" action="" onsubmit="return validate();">
			...
			<h2><b >Update price of the existing products</h2>
			<p></p>
...
<input type="hidden" value="" name="model1" id="model1">		
		</div> <br>
		</li>		<li id="li_5" >
		<label class="description" for="element_5">Price </label>
		<div>
			<input id="element_5" name="element_5" class="element text small" type="number" value="" placeholder="Price"/> 
		</div> <br>
		</li>		<li id="li_6" >
		<label class="description" for="element_6">Confirm Price </label>
		<div>
			<input id="element_6" name="element_6" class="element text small" type="number" value="" placeholder="Confirm price"/> 
		</div> <br>
		</li>
				...
				<input id="saveForm" class="btn btn-primary" type="submit" name="submit" value="Finish"/> 
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input id="saveForm" class="btn btn-primary" type="submit" name="submit" onclick="Edit Price final.php" value="Continue updating" />
		</li>
			</ul>
	</form>	
