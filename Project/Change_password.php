...
<?php
    ...
    require_once('Change_password_php.php');
    $j= new change_pass1();
   $ch=$j->change_pass();
?>
<!DOCTYPE html>
...
<script type="text/javascript" src="view.js"></script>
	...
	function change(){
	 var old = document.myform.password;
      var new1 = document.myform.new_password;
      var new2 = document.myform.confirm_password;
	   ...
	   if(new1.value.length<6 || new1.value.length>20)
	   {
...
<body>
	...
	<br>
		...
		<form name="myform" id="form_992796" class="appnitro"  method="POST" onsubmit="return change();">
					<div class="form_description">
			<h2><b>Change Password</h2>
			<p></p>
	...
	<li id="li_1" >
		<label class="description" for="group_name">Current Password</label>
			<input id="password" name="password" class="element text large" type="password" placeholder="Password" size="100" required/> 
		</li>	
		<br>
     <li id="li_1" >
		<label class="description" for="group_name">New Password</label>
			<input id="new_password" name="new_password" class="element text large" type="password" placeholder="New Password" size="100" required/> 
		</li>	
		<br>
	<li id="li_1" >
		<label class="description" for="group_name">Confirm Password</label>
			<input id="confirm_password" name="confirm_password" class="element text large" type="password" placeholder="Confirm New Password" size="100" required/> 
		</li>	
		<br>
						
							<li class="buttons">
			    
				<input id="saveForm" class="btn btn-primary" type="submit" name="submit" value="Change Password"/> 
	<?php 
